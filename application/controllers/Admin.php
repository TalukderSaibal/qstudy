...
class Admin extends CI_Controller
{
    ...
    public function save_course_schedule()
    {
        ...
        $data['course_access'] = $_POST['course_access'];
    ...
    public function coursesByCountry($countryId, $studentId = 0, $type = '', $subscription_type = '',$user_type)
    {

        if($subscription_type=='signup'){
            $status = 1;
        }else{
            $status = 2;
        }
        ...
        if ($type == "edit") {
            ...
            $data['register_course'] =$studentCourses;
            return $data;
        }
        echo $html;
    }
    ...
    public function  idea_create_tutor_list($tutor_id)
    {
        ...
        // echo "<pre>";print_r($data['tutor_questions']);die();
    ...
    public function student_idea_setting($question_id,$idea_id,$student_id,$module_id){
        ...
        $data['idea_correction'] = $this->admin_model->get_teacher_idea_correction($idea_id,$student_id,$module_id);
    ...
    public function upload_idea_story_options_admin(){
        $return=array();
		if($_FILES['file']['name'] != ''){
    ...
    public function teacher_idea_correction_save()
    {
        ...
        $idea_id= $this->input->post('idea_id');
        $total_title_mark= $this->input->post('total_title_mark');
        $spelling_error_value= $this->input->post('spelling_error_value');
        $total_spelling_mark= $this->input->post('total_spelling_mark');
        $creative_sentence_mark=$this->input->post('creative_sentence_mark');
        $creative_sentence_index=$this->input->post('creative_sentence_index');
        $creative_sentence_color=$this->input->post('creative_sentence_color');
        $st_title_text=$this->input->post('st_title_text');
        $st_spelling_text=$this->input->post('st_spelling_text');
        $st_creative_text=$this->input->post('st_creative_text');
        $introduction_point=$this->input->post('introduction_point');
        $introduction_index=$this->input->post('every_introduction_index');
        $introduction_text=$this->input->post('st_introduction_text');
        $body_paragraph_point= $this->input->post('body_paragraph_point');
        $body_paragraph_index= $this->input->post('every_body_index');
        $body_paragraph_text= $this->input->post('st_body_paragraph_text');
        $conclusion_point= $this->input->post('conclusion_point');
        $conclusion_index= $this->input->post('every_conclusion_index');
        $conclusion_text= $this->input->post('st_conclusion_text');


        if(isset($module_id) && $module_id !='') $data['module_id']=$module_id;
        if(isset($question_id) && $question_id !='') $data['question_id']=$question_id;
        if(isset($student_id) && $student_id !='') $data['student_id']=$student_id;
        if(isset($teacher_id) && $teacher_id !='') $data['teacher_id']=$teacher_id;
        if(isset($idea_id) && $idea_id !='') $data['idea_id']=$idea_id;
        if(isset($total_title_mark) && $total_title_mark !='') $data['total_title_mark']=$total_title_mark;
        if(isset($spelling_error_value) && $spelling_error_value !='') $data['spelling_error_value']=$spelling_error_value;
        if(isset($total_spelling_mark) && $total_spelling_mark !='') $data['total_spelling_mark']=$total_spelling_mark;
        if(isset($creative_sentence_mark) && $creative_sentence_mark !='') $data['creative_sentence_mark']=$creative_sentence_mark;
        if(isset($creative_sentence_index) && $creative_sentence_index !='') $data['creative_sentence_index']=$creative_sentence_index;
        if(isset($creative_sentence_color) && $creative_sentence_color !='') $data['creative_sentence_color']=$creative_sentence_color;
        if(isset($st_title_text) && $st_title_text !='') $data['st_title_text']=$st_title_text;
        if(isset($st_spelling_text) && $st_spelling_text !='') $data['st_spelling_text']=$st_spelling_text;
        if(isset($st_creative_text) && $st_creative_text !='') $data['st_creative_text']=$st_creative_text;
        if(isset($introduction_point) && $introduction_point !='') $data['introduction_point']=$introduction_point;
        if(isset($introduction_index) && $introduction_index !='') $data['introduction_index']=$introduction_index;
        if(isset($introduction_text) && $introduction_text !='') $data['introduction_text']=$introduction_text;
        if(isset($body_paragraph_point) && $body_paragraph_point !='') $data['body_paragraph_point']=$body_paragraph_point;
        if(isset($body_paragraph_index) && $body_paragraph_index !='') $data['body_paragraph_index']=$body_paragraph_index;
        if(isset($body_paragraph_text) && $body_paragraph_text !='') $data['body_paragraph_text']=$body_paragraph_text;
        if(isset($conclusion_point) && $conclusion_point !='') $data['conclusion_point']=$conclusion_point;
        if(isset($conclusion_index) && $conclusion_index !='') $data['conclusion_index']=$conclusion_index;
        if(isset($conclusion_text) && $conclusion_text !='') $data['conclusion_text']=$conclusion_text;
        ...
        if(empty($check_insert)){
            ...
            $checked['student_ans_check_by'] = 3;
            $checked['examine_status'] = 1;
            $this->db->where('id', $this->input->post('idea_id'));
            $update = $this->db->update('question_ideas', $checked);
        }else{
            $this->db->where('student_id',$this->input->post('student_id'));
            $this->db->where('question_id',$this->input->post('question_id'));
            $this->db->where('idea_id',$this->input->post('idea_id'));
            $update = $this->db->update('tutor_correction_idea_info',$data);
    ...
    public function teacher_idea_correction_update()
    {
        //echo "<pre>";print_r($_POST);die();

        $title_option_one=$this->input->post('title_option_one');
        $title_option_one_hint=$this->input->post('title_option_one_hint');
        $title_option_two=$this->input->post('title_option_two');
        $title_option_two_hint=$this->input->post('title_option_two_hint');
        $title_option_three=$this->input->post('title_option_three');
        $title_option_three_hint=$this->input->post('title_option_three_hint');
        $title_option_four=$this->input->post('title_option_four');
        $title_option_four_hint=$this->input->post('title_option_four_hint');

        $other_title_student_ans= $this->input->post('other_title_student_ans');

        $option_one_image=$this->input->post('option_one_image');
        $option_two_image=$this->input->post('option_two_image');
        $option_three_image=$this->input->post('option_three_image');
        $option_four_image=$this->input->post('option_four_image');
        $image_option_points=$this->input->post('image_option_points');
        $image_option_ans=$this->input->post('image_option_ans');
        $option_one_image_texts=$this->input->post('option_one_image_texts');

        $ss_intro_option_one=$this->input->post('ss_intro_option_one');
        $ss_intro_option_one_hint=$this->input->post('ss_intro_option_one_hint');
        $ss_intro_option_two=$this->input->post('ss_intro_option_two');
        $ss_intro_option_two_hint=$this->input->post('ss_intro_option_two_hint');
        $ss_intro_option_three=$this->input->post('ss_intro_option_three');
        $ss_intro_option_three_hint=$this->input->post('ss_intro_option_three_hint');
        $ss_intro_option_four=$this->input->post('ss_intro_option_four');
        $ss_intro_option_four_hint=$this->input->post('ss_intro_option_four_hint');

        $ss_body_paragraph_option_one=$this->input->post('ss_body_paragraph_one');
        $ss_body_paragraph_option_one_hint=$this->input->post('ss_body_paragraph_one_hint');
        $ss_body_paragraph_option_two=$this->input->post('ss_body_paragraph_two');
        $ss_body_paragraph_option_two_hint=$this->input->post('ss_body_paragraph_two_hint');
        $ss_body_paragraph_option_three=$this->input->post('ss_body_paragraph_three');
        ...
        $ss_conclution_option_two_hint=$this->input->post('ss_conclution_two_hint');
        $ss_conclution_option_three=$this->input->post('ss_conclution_three');
        $ss_conclution_option_three_hint=$this->input->post('ss_conclution_three_hint');
        $ss_conclution_option_four=$this->input->post('ss_conclution_four');
        $ss_conclution_option_four_hint=$this->input->post('ss_conclution_four_hint');

        if(isset($title_option_one) && $title_option_one !='') $title['title_option_one']=$title_option_one;
        if(isset($title_option_one_hint) && $title_option_one_hint !='') $title['title_option_one_hint']=$title_option_one_hint;
        if(isset($title_option_two) && $title_option_two !='') $title['title_option_two']=$title_option_two;
        if(isset($title_option_two_hint) && $title_option_two_hint !='') $title['title_option_two_hint']=$title_option_two_hint;
        if(isset($title_option_three) && $title_option_three !='') $title['title_option_three']=$title_option_three;
        if(isset($title_option_three_hint) && $title_option_three_hint !='') $title['title_option_three_hint']=$title_option_three_hint;
        if(isset($title_option_four) && $title_option_four !='') $title['title_option_four']=$title_option_four;
        if(isset($title_option_four_hint) && $title_option_four_hint !='') $title['title_option_four_hint']=$title_option_four_hint;

        if(isset($other_title_student_ans) && $other_title_student_ans !='') $data['other_title_student_ans']=$other_title_student_ans;


        if(isset($option_one_image) && $option_one_image !='') $image['option_one_image']=$option_one_image;
        if(isset($option_two_image) && $option_two_image !='') $image['option_two_image']=$option_two_image;
        if(isset($option_three_image) && $option_three_image !='') $image['option_three_image']=$option_three_image;
        if(isset($option_four_image) && $option_four_image !='') $image['option_four_image']=$option_four_image;
        if(isset($image_option_points) && $image_option_points !='') $image['image_option_points']=$image_option_points;
        if(isset($image_option_ans) && $image_option_ans !='') $image['image_option_ans']=$image_option_ans;
        if(isset($option_one_image_texts) && $option_one_image_texts !='') $image['option_one_image_texts']=$option_one_image_texts;


        if(isset($ss_intro_option_one) && $ss_intro_option_one !='') $ss_intro['ss_intro_option_one']=$ss_intro_option_one;
        if(isset($ss_intro_option_one_hint) && $ss_intro_option_one_hint !='') $ss_intro['ss_intro_option_one_hint']=$ss_intro_option_one_hint;
        if(isset($ss_intro_option_two) && $ss_intro_option_two !='') $ss_intro['ss_intro_option_two']=$ss_intro_option_two;
        if(isset($ss_intro_option_two_hint) && $ss_intro_option_two_hint !='') $ss_intro['ss_intro_option_two_hint']=$ss_intro_option_two_hint;
        if(isset($ss_intro_option_three) && $ss_intro_option_three !='') $ss_intro['ss_intro_option_three']=$ss_intro_option_three;
        if(isset($ss_intro_option_three_hint) && $ss_intro_option_three_hint !='') $ss_intro['ss_intro_option_three_hint']=$ss_intro_option_three_hint;
        ...
        if(isset($ss_body_paragraph_option_two) && $ss_body_paragraph_option_two !='') $ss_body['ss_body_paragraph_option_two']=$ss_body_paragraph_option_two;
        if(isset($ss_body_paragraph_option_two_hint) && $ss_body_paragraph_option_two_hint !='') $ss_body['ss_body_paragraph_option_two_hint']=$ss_body_paragraph_option_two_hint;
        if(isset($ss_body_paragraph_option_three) && $ss_body_paragraph_option_three !='') $ss_body['ss_body_paragraph_option_three']=$ss_body_paragraph_option_three;
        if(isset($ss_body_paragraph_option_three_hint) && $ss_body_paragraph_option_three_hint !='') $ss_body['ss_body_paragraph_option_three_hint']=$ss_body_paragraph_option_three_hint;
        if(isset($ss_body_paragraph_option_four) && $ss_body_paragraph_option_four !='') $ss_body['ss_body_paragraph_option_four']=$ss_body_paragraph_option_four;
        if(isset($ss_body_paragraph_option_four_hint) && $ss_body_paragraph_option_four_hint !='') $ss_body['ss_body_paragraph_option_four_hint']=$ss_body_paragraph_option_four_hint;



        if(isset($ss_conclution_option_one) && $ss_conclution_option_one !='') $ss_conclution['ss_conclution_option_one']=$ss_conclution_option_one;
        if(isset($ss_conclution_option_one_hint) && $ss_conclution_option_one_hint !='') $ss_conclution['ss_conclution_option_one_hint']=$ss_conclution_option_one_hint;
        if(isset($ss_conclution_option_two) && $ss_conclution_option_two !='') $ss_conclution['ss_conclution_option_two']=$ss_conclution_option_two;
        if(isset($ss_conclution_option_two_hint) && $ss_conclution_option_two_hint !='') $ss_conclution['ss_conclution_option_two_hint']=$ss_conclution_option_two_hint;
        if(isset($ss_conclution_option_three) && $ss_conclution_option_three !='') $ss_conclution['ss_conclution_option_three']=$ss_conclution_option_three;
        if(isset($ss_conclution_option_three_hint) && $ss_conclution_option_three_hint !='') $ss_conclution['ss_conclution_option_three_hint']=$ss_conclution_option_three_hint;
        if(isset($ss_conclution_option_four) && $ss_conclution_option_four !='') $ss_conclution['ss_conclution_option_four']=$ss_conclution_option_four;
        if(isset($ss_conclution_option_four_hint) && $ss_conclution_option_four_hint !='') $ss_conclution['ss_conclution_option_four_hint']=$ss_conclution_option_four_hint;
        ...
        //$data['st_creative_text']=$this->input->post('st_creative_text');
        ...
        $other_creative_sentence_mark=$this->input->post('other_creative_sentence_mark');
        $other_metaphor_text=$this->input->post('other_metaphor_text');

        if(isset($other_total_spelling_mark) && $other_total_spelling_mark !='') $data['other_total_spelling_mark']=$other_total_spelling_mark;
        if(isset($other_spelling_error_value) && $other_spelling_error_value !='') $data['other_spelling_error_value']=$other_spelling_error_value;
        if(isset($other_creative_sentence_index) && $other_creative_sentence_index !='') $data['other_creative_sentence_index']=$other_creative_sentence_index;
        if(isset($other_creative_sentence_mark) && $other_creative_sentence_mark !='') $data['other_creative_sentence_mark']=$other_creative_sentence_mark;
        if(isset($other_metaphor_text) && $other_metaphor_text !='') $data['other_metaphor_text']=$other_metaphor_text;

        if(isset($image) && $image !='') $data['image']= json_encode($image);
        if(isset($title) && $title !='') $data['title']= json_encode($title);
        if(isset($ss_intro) && $ss_intro !='') $data['ss_intro']= json_encode($ss_intro);
        if(isset($ss_body) && $ss_body !='') $data['ss_body']= json_encode($ss_body);
        if(isset($ss_conclution) && $ss_conclution !='') $data['ss_conclution']= json_encode($ss_conclution);

        //echo "<pre>";print_r($data);die();
        // echo "<pre>";print_r($this->input->post('question_id'));die();
