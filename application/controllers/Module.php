...
//                }
    ...
    public function newModuleDuplicate()
    {
        ...
        if($withQuestion == 1){
            ...
            if($this->input->post('moduleType')==2){
                $repetition_data = [];
                $a = [];
                $i = 0;
                $j = 1;
    ...
    public function searchModuleByOptions(){
        ...
        $this->session->set_userdata('search_course_name', $course_id);
        $this->session->set_userdata('search_module_name', $module_name);
