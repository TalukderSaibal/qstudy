                      ...
                      <tr>
                        ...
                        <td>
                          <?php if (isset($vocabularyCommission) && $vocabularyCommission != 0) {   ?>
                            <a href="q-dictionary/payment"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></a>
                          <?php } ?>
                        </td>
                        <td>
                          <?php if (isset($vocabularyCommission) && $vocabularyCommission == 0) {   ?>
                      ...
                      <tr>
                        <td>
                          <?php if (isset($user_message)) {   ?>
                            <a href="contact-mail" > Email <span style="color:red;font-weight:bold;display: inline;"><?= (isset($user_message))?$user_info[0]['SCT_link']:'' ?></span>
                                </a>
                          <?php }else{ ?>
                            Email
                          <?php } ?>
                    ...
                    <div class="info-details" style="margin-left: 12px;margin-top: 7px;">
                        ...
                        <div class="form-group row">
                          ...
                          <?php foreach ($studentsRefLink as $srl) : ?>
                            <div class="col-sm-2">
                              <a  href="edit_user/<?php echo $srl['id']; ?>"><?php echo $srl['name']; ?></a>
                            </div>
                          <?php endforeach; ?>
                        </div>
                        <?php endif ; ?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-2">
                          <a href="edit_user/<?php echo $user_info[0]['parent_id']; ?>">Parent</a>
                          </div>
                        </div>
                        <?php endif ; ?>
                        ...
                        <?php
                          ...
                          <div class="form-group row">
                            ...
                            <?php foreach ($NumberOfTutor as $NOfT => $value): ?>
                              <div class="col-sm-2">
                                <a  href="edit_user/<?php echo $value['id']; ?>"><?php echo $value['name']; ?></a>
                              </div>
                            <?php endforeach ?>
                          </div>
                          <?php endif ?>
                        ...
                        <?php
                          ...
                          if (isset($corporate) && $user_info[0]['user_type'] == 3): ?>
                            ...
                            <div class="col-sm-2" style="margin: 0;padding: 0;">
                              <a  href="edit_user/<?php echo $corporate->id; ?>"><?php echo $corporate->name; ?></a>
                            </div>
                        <?php endif ?>
                      </div>
                      <div class="form-group row">
    ...
    <div class="ss_top_s_course">
                                ...
                                <?php $course_name = preg_split('#<p([^>])*>#',$course_info['courseName']);
                                    ...
                                    <div class="col-md-6">
                                        <?php if(!empty($course_info['image_name'])){?>
                                            <img src="assets/course_image/<?=$course_info['image_name']?>" style="height: 200px;width: 110px;">
                                        <?php }?>
                                    </div>
                                </div>
                                  <div class="cost_box cost_box_no<?=$i;?>" style="bottom:23px !important;<?php if(in_array($course_info['id'],$register_course)){echo "background-color: red !important;color:white !important;";} ?>">$<?=$course_info['courseCost']?></div>
                                </div>
                               </label>
                            </div>
                                        ...
                                        <div class="course_one_serial selected_course selected_course<?=$i;?>" data-id="<?=$i;?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3" style="min-height:175px;">
                                                    <div class="cost_box cost_box_no<?=$i;?>" style="position: absolute; bottom:-38px; height: 50px;width: 51px;border-radius: 50%;padding-top: 16px;padding-left: 10px;<?php if(in_array($course_info['id'],$register_course)){echo "background-color: red;color:white;";}else{echo "background-color: #b0e7fa;";} ?>">$<?=$course_info['courseCost']?></div>
                                                </div>
                                                <div class="col-md-9">
                                                    <div>
                                        ...
                                        <div class="course_one_serial selected_course selected_course<?=$i;?>" data-id="<?=$i;?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3" style="min-height:50px;">
                                                    <div class="cost_box cost_box_no<?=$i;?>" style="position: absolute; bottom:-32px; height: 50px;width: 51px;border-radius: 50%;padding-top: 16px;padding-left: 10px;<?php if(in_array($course_info['id'],$register_course)){echo "background-color: red;color:white;";}else{echo "background-color: #b0e7fa;";} ?>">$<?=$course_info['courseCost']?></div>
                                                </div>
                      ...
                      foreach($all_courses as $course_info){ ?>
                                ...
                                <label for="course_<?php echo $i; ?>" style="display: block;">
                                    <div for="course_<?php echo $i; ?>" class="course_two_serial selected_course selected_course<?=$i;?>" data-id="<?=$i;?>">
                                        ...
                                        <div style="width:100%;padding:20px 15px;">
                                            <div class="cost_box cost_box_no<?=$i;?>" style="<?php if(in_array($course_info['id'],$register_course)){echo "background-color: red !important;color:white !important;";} ?>">$<?=$course_info['courseCost']?></div>
                                        </div>
                                    </div>
                                </label>
                            </div>
                        ...
                        <?php }else if($i==3){?>
                            <div class="col-md-4" style="margin-top: 15px;">
                                <div style="position:relative">
                                    <input type="checkbox" class="course_checkbox" name="course[]" id="course_<?php echo $i; ?>" data="<?php echo $course_info['courseCost'] ?>" data-id="<?=$i;?>" value="<?php echo $course_info['id'] ?>" <?php if(in_array($course_info['id'],$register_course)){echo "checked";} ?>>
                        ...
                        <?php }else if($i==5){?>
                            <div class="col-md-4" style="margin-top: 15px;">
                                <div style="position:relative">
                                    <input type="checkbox" name="course[]" id="course_<?php echo $i; ?>" data="<?php echo $course_info['courseCost'] ?>"class="course_checkbox" data-id="<?=$i;?>" value="<?php echo $course_info['id'] ?>" <?php if(in_array($course_info['id'],$register_course)){echo "checked";} ?>>
                        ...
                        <?php }else if($i>6){?>
                            <div class="col-md-4" style="margin-top: 15px;">
                                <div style="position:relative">
                                    <input type="checkbox" id="course_<?php echo $i; ?>" data="<?php echo $course_info['courseCost'] ?>"class="course_checkbox" data-id="<?=$i;?>" value="<?php echo $course_info['id'] ?>" <?php if(in_array($course_info['id'],$register_course)){echo "checked";} ?>>
                                    <label for="course_<?php echo $i; ?>" style="display: block;">
                                        <div class="course_two_serial selected_course selected_course<?=$i;?>">
