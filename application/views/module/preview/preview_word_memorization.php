                                    ...
                                    <div class="panel-body ss_imag_add_right" style="padding:0;">
                                        ...
                                        <div class="sentence_body">
                                                ...
                                                ?>
                                                    <div style="display: flex;">
                                                        ...
                                                        <div class="ans_info<?= $j ?>">
                                                            &nbsp;&nbsp;
                                                            <i class="fa fa-close wrong_ans<?= $j ?>" style="font-size:24px;padding-top:1px;color:red; display:none;"></i>
                                                            <i class="fa fa-check right_ans<?= $j ?>" style="font-size:24px;padding-top:1px;color:green; display:none;"></i>
                                                        </div>
                                                        &nbsp;&nbsp;
                                                        <div style="display:none;" class="suggession_box<?= $j ?>">
                                            ...
                                            <div>
                                                ...
                                                <a href="javascript:;" type="button" class="btn btn-primary" style="background-color: #fb8836;float:left;display:none;" id="start_memo">Start memorization</a>
