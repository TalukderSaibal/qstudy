...
//echo "<pre>"; print_r($question_info[0]['video_name']); die();
?>
                            ...
                            <?php if ($question_time_in_second != 0) { ?>
                                ...
                                <li>
                                    <div class="ss_timer" id="demo">
                                        <h1 style="padding: 10px;border: 1px solid #cfc4c4;">00:00:00 </h1>
                                    </div>
                                </li>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <?php if (isset($question_info[0]['video_name']) && $question_info[0]['video_name'] != '') { ?>
                    <h6 class="text-center"><?= $question_info[0]['video_name'] ?></h6>
                <?php } else { ?>
