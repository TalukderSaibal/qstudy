                  ...
                  <div class="ss_s_b_main" style="min-height: 100vh">
                     ...
                     <div class="panel-body">
                        <div class="row panel-body" style="clear: both;display: flex;flex-wrap: wrap;">
                           <div class="col-md-8" style="border: 1px solid #c3c3c3;padding: 5px;position:relative;">

                              <?php if ($question_description['image_type_one'] == 1) { ?>
                                 <p style="display: inline-block;padding: 5px 10px;margin-top: 5px;background-color:#f0f0f0;font-weight:bold;font-size: 15px;">
                                    <?= strip_tags($question_description['question']) ?></p>
                                 <div style="text-align: center;">
                                    <div style="min-height:200px;margin-top:15px;width: 75%;margin: 10% 12% 12% 12%;" class="type1_box1_image">
                                       <img class="box_one_one" src="<?= base_url() ?>/assets/imageQuiz/<?= $question_description['box_one_image'] ?>" />
                                    </div>
                                 </div>
                                 <div class="explaination_text_two" style="position:absolute;left:90%;top:225px;min-width: 400px;z-index:1;">
                              ...
                              <?php } else if ($question_description['image_type_two'] == 1) { ?>
                                 <p style="display: inline-block;padding: 5px 10px;margin-top: 5px;background-color:#f0f0f0;font-weight:bold;font-size: 15px;">
                                    <?= strip_tags($question_description['question']) ?></p>
                                 <div style="text-align: center;">
                                    <div style="min-height:200px;margin-top:15px;width: 100%;" class="type1_box1_image">
                              ...
                              <?php } else if ($question_description['image_type_three'] == 1) { ?>
                                 <p style="display: inline-block;padding: 5px 10px;margin-top: 5px;background-color:#f0f0f0;font-weight:bold;font-size: 15px;">
                                    <?= strip_tags($question_description['question']) ?></p>
                                 <div style="text-align: center;">
                                    <div style="min-height:700px;margin-top:15px;width: 100%;" class="type1_box1_image">
                                       <img class="box_three_one" src="<?= base_url() ?>/assets/imageQuiz/<?= $question_description['box_three_image'] ?>" />
                                    </div>
                                 </div>

                                 <div class="explaination_text_two" style="position:absolute;left:95%;top:225px;min-width: 400px;z-index:1;">
                                    <div style="background-color:#fffe91;padding:10px;margin-bottom:10px;font-weight:bold;">
                                       <?= $question_description['quiz_explaination'] ?>
                                    </div>
   ...
   $('.ans_submit').click(function() {
      ...
      <?php if ($answer == 'write') { ?>
         ...
         if (question_description == '') {
            ...
            $.ajax({
               type: 'POST',
               url: 'question_answer_matching_image_quiz',
               data: form.serialize(),
               dataType: 'html',
