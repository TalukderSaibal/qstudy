                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                    <div class="image_q_list" style="font-size: 16px;">

                                    <div class="row">
                                        <div class="col-xs-5 text-right  col-lg-4">Word</div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-5 text-right  col-lg-4">Definition</div>
                                        <div class="col-xs-1" style="padding-left: 0;">: </div>
                                        <div class="col-xs-5 col-lg-6"> <?php echo $question_info;?></div>
                                    </div>

                                    <?php }?>

                                    <?php
                                    if(!empty($demoquestions)){
                                        $i = 0;
                                        $jsonQuestions = json_decode($demoquestions);
                                        foreach($jsonQuestions as $jsonvalue){ ?>
                                        <?php $i++; ?>
                                            <div class="row">
                                                <div style="width:35%" class="col-xs-5 text-right  col-lg-4">Audio File . <?= $i ?></div>
                                                <div class="col-xs-1"style="padding-left: 0;">: </div>
                                                <div class="col-xs-5 col-lg-6">
                                                    <audio controls style="width:185px;">
                                                        <source src="assets/audiouploads/<?= $jsonvalue->audio ?>" type="audio/mpeg">
                                                    </audio>
                                                </div>
                                            </div>
                                        <?php  }
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-5 text-right  col-lg-4">Audio File</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-5 text-right  col-lg-4">Video file</div>
                                        <?php endif;?>
                                                ...
                                                <div class="row">
                                                    <div class="">
                                                        <div class="">
                                                            ...
                                                            $json = json_decode($demoquestions);

                                                            ?>
                                                            <?php foreach ($json as $key=> $row) {?>

                                                            <div class="result_board">
                                                                <input type="checkbox" name="checkQuestion[]" value="<?= $key; ?>">
                                                                <?php echo $row->image?>
                                                                <p><?= $row->text ?></p>
                                                                <audio controls style="width:185px;">
                                                                    <source src="assets/audiouploads/<?= $row->audio ?>" type="audio/mpeg">
                                                                </audio>
                                                            </div>
...
<script>
    ...
    if (remaining_time > 0) {
        ...
        $.ajax({
        type: 'POST',
        url: 'IDontLikeIt/answer_matching_vocabolary',
        data: form.serialize(),
        dataType: 'html',
        success: function (results) {
            if (results == 1) {
