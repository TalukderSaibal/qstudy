...
$question = $comprehension_info[0]['questionName'];
$answer = $comprehension_info[0]['answer'];
$question_description = json_decode($comprehension_info[0]['questionDescription'], true);
// echo "ggg".$answer;die();
                        ...
                        <div class="row panel-body" style="clear: both;display: flex;flex-wrap: wrap;">
                           <div class="col-md-6 row-eq-height" style="border: 1px solid #82bae6;padding: 5px;box-shadow: 0px 0px 4px #82bae6;border-radius: 5px;">
                              ...
                              <div style="word-break:break-word">
                                 ...
                                 $com_hint_type = $question_description['com_hint_type'];
                                 if ($com_hint_type == 'word') {
                                    $k = 1;
                                    ...
                                    echo $al_words;
                                 } else if ($com_hint_type = 'sentence') {

                                    $k = 1;
                                    foreach ($get_sentences as $sentence) {
                                       $al_sentence .= '<p>';
                                       $get_sentences_ex = explode('.', strip_tags($sentence));
                                       if ($k == 1) {
                                          $i = 0;
                                          $j = 0;
                                       }
                                       $total_sentence = count($get_sentences_ex);
                                       $ii = 1;
                                       foreach ($get_sentences_ex as $get_sentence) {

                                          if ($ii <= $total_sentence) {
                                             if (ctype_space($get_sentence)) {
                                                $al_sentence .= '<span class="write_input_word write_input_word' . $j . '" data-index="' . $j . '">' . $get_sentence . '</span>';
                                                $j++;
                                             } else {
                                                $al_sentence .= '<span class="write_input_word write_input_word' . $j . '" data-index="' . $j . '">' . $get_sentence . '.</span>';
                                                $j++;
                           ...
                           <div class="col-md-5">
                              ...
                              <form id="answer_form">
                                 ...
                                 <?php } else { ?>
                                    <div class="with_option" style="height:100%;border:1px solid gray;padding:5px;margin-left:3%;overflow: hidden;">
                                       <br>
                                       <h6 style="font-weight: bold;margin-left:30px;font-size:17px;"> <?= $comprehension_info[0]['questionName']; ?></h6>
                                       <br>
                                       <?php
                                       $i = 1;
...
<script>
   ...
   $('#ans_help').click(function() {
      ...
      // console.log(first_hint);
      // console.log(second_hint);
      var com_hint_type = '<?= $question_description['com_hint_type'] ?>';
