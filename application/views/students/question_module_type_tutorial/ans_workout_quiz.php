...
<div class="container-fluid">
  <form id="answer_form">
    ...
    <?php // if (array_key_exists($key, $total_question) && !$tutorial_ans_info) { ?>
      ...
      <div class="row">
	  <div>
              <div style="position: absolute;left:-8000px;min-height: 250px;min-width: 600px;text-align: center;" id="quesBody">
		  ...
		  <div class="col-sm-2">
            ...
            <!--<div class="col-sm-4">
              <strong class="text-center">
               <a href="javascript:void(0)" style="text-decoration: underline;padding:10px;" onclick="test('preview')">Workout</a>
             </strong>
                        ...
                        <div class="table-responsive">
                          ...
                          <tbody>
                              ...
                              <td class="text-center">
                                  <a  class="text-center" onclick="showModalDes(<?php echo $i; ?>);" style="display: inline-block;"><img src="assets/images/icon_details.png"></a>
                                    <?php
                                    ...
                                    <?php if (isset($question_instruct_vid[0]) && $question_instruct_vid[0] != null ){ ?>
                                      <a onclick="showQuestionVideo(<?php echo $i; ?>)" class="text-center" style="display: inline-block;"><img src="http://q-study.com/assets/ckeditor/plugins/svideo/icons/svideo.png"></a>
                                    <?php } ?>
                              </td>
                            </tr>
                                  <?php $i++;
...
$('#answer_matching').click(function () {
            ...
            $('#capture').html(text_answer);
            var text_answer_capture = $('#capture').val();


              html2canvas(document.querySelector("#capture")).then(canvas => {
                  var canvaseImg = canvas.toDataURL();
                  console.log(canvaseImg);
                  $.ajax({
                      type: 'POST',
                      url: 'module/get_draw_image',
                      data: {
                          imageData: canvaseImg,
                      },
                      dataType: 'html',
