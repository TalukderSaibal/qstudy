...
<script>
    ...
    $('#answer_matching').click(function() {
        ...
        if ((PercentageObj != stdAnsLen) && ansFiled == '') {
            ...
            $.ajax({
                type: 'POST',
                url: 'Student/st_answer_matching_without_form_workout_two',
                data: {
                    checkAllFiled: checkAllFiled,
    ...
    $("#answer_saving").click(function() {
        ...
        for (var Tid = 1; Tid <= totalP; Tid++) {
            ...
            $(".c_percent_0_" + Tid).css({
                "background": "#fff",
                "color": "#444444"
            });
            $(".c_percent_25_" + Tid).css({
                "background": "#fff",
                "color": "#444444"
            });
            $(".c_percent_50_" + Tid).css({
                "background": "#fff",
                "color": "#444444"
            });
            $(".c_percent_100_" + Tid).css({
                "background": "#fff",
                "color": "#444444"
            });
            $("#box_" + Tid).css({
...
<?php $this->load->view('students/question_module_type_tutorial/drawingBoardForWorkoutTwo'); ?>