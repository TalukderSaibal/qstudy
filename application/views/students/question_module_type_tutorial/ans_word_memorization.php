                    ...
                    <div class="sentence_body">
                      ...
                      <div id="skip_others">
                        ...
                        <div id="question_list">
                          <h5 style="text-decoration: underline;color:#6ea6c5;font-size:21px;font-weight:bold;"><?php if ($question_info_s[0]['country'] == 1 || $question_info_s[0]['country'] == 9) {
                                                                                                                  echo "Memorise";
                                                                                                                } else {
                                                                                                                  echo "Memorize";
                                                                                                                } ?> the sentences and words</h5>
                          <br>
                        ...
                        <div id="answer_list" style="display:none;">
                          <h5 style="text-decoration: underline;color:#6ea6c5;font-size:21px;font-weight:bold;"><?php if ($question_info_s[0]['country'] == 1 || $question_info_s[0]['country'] == 9) {
                                                                                                                  ...
                                                                                                                  echo "Memorize";
                                                                                                                } ?> the spelling of words <span style="color:red;">Serially.</span></h5>
                          <br>
                          <?php
                      ...
                      <div id="student_answers_list" style="display: none;">
                        <h5 style="text-decoration: underline;color:#6ea6c5;font-size:21px;font-weight:bold;">Write the words <span style="color:red;">Serially</span> that you have <?php if ($question_info_s[0]['country'] == 1 || $question_info_s[0]['country'] == 9) {
                                                                                                                                                                                        echo "memorised";
                                                                                                                                                                                      } else {
                                                                                                                                                                                        echo "memorized";
                                                                                                                                                                                      } ?></h5>
                      ...
                      <div>
                        ...
                        <a href="javascript:;" type="button" class="btn btn-primary" style="background-color: #fb8836;float:left;display:none;" id="start_memo">Start <?php if ($question_info_s[0]['country'] == 1 || $question_info_s[0]['country'] == 9) {
                                                                                                                                                                        echo "Memorisation";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo "Memorization";
                                                                                                                                                                      } ?></a>
...
<?php //echo "<pre>";print_r($total_question);die();
?>
  ...
  $(document).ready(function() {
    ...
    $('#ans_submit').click(function() {
      ...
      if (question_length == answer_length) {
        ...
        $.ajax({
          type: 'POST',
          url: 'st_answer_word_memorization',
          data: form.serialize(),
          dataType: 'html',
          success: function(results) {
            if (results == 2) {
              ...
              for (var i = 0; i < answers.length; i++) {
                ...
                var get_ans = get_ans.toLowerCase();
                var matchNotRight = 0;
