               ...
               <div class="row">
                  <div class="ss_s_b_main" style="min-height: 100vh">
                    <div class="col-sm-12">
                        ...
                        ?>
                        <h2 style="font-weight:bold;text-align:center;font-family: 'Comic Sans MS';color:<?=$question_description['title_color']?>"><?=$question_description['question_title_description']?></h2>
